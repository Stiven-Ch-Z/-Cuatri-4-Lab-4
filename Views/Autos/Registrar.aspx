...
runat="server"> 
    ...
    <h2>Registrar Auto</h2> <!-- Encabezado de la vista --> 
    ...
    <br /> 
    <asp:Button ID="btnRegistrar" runat="server" Text="Registrar" OnClick="btnRegistrar_Click" CssClass="btn" /> <!-- Botón que ejecuta la acción de registro --> 
